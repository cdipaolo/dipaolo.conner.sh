...
![Neural Network](https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/ArtificialNeuronModel_english.png/600px-ArtificialNeuronModel_english.png)
...
<div>
\[ \int_0^1{x^2dx} = \frac{x^3}{3}|^1 = \frac{1}{3} \]
</div>
...
![Kernel Machine](https://upload.wikimedia.org/wikipedia/commons/1/1b/Kernel_Machine.png)
